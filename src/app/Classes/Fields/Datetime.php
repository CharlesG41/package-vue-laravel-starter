...
class Datetime extends BaseField implements FieldInterface, \JsonSerializable
{
    const TYPE = 'datetime';
    ...
    static public function instantiateFromEloquentField(EloquentField $eloquentField, ?int $entryId): self
    {
        ...
        $field = new self(
            ...
            $fieldAttributesAsKeyValue['is_future'],
            $conditions,
            $fieldPermissions,
    ...
    public function isValid($value): bool
    {
        ...
        if ($this->isFuture && strtotime($value) < time()) {
            $this->error = __('cyvian.errors.is_future');
            return false;
        }
