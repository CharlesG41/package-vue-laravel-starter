...
class GetEntryTypeById
{
    ...
    public function handle(int $id, bool $withForm = true, bool $withActions = true): EntryType
    {
        $eloquentEntryType = $this->entryTypeRepository->getEntryTypeById($id);
