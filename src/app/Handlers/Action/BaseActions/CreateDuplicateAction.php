    ...
    public function handle(int $entryTypeId, array $roleIds, bool $rolesByEntry): Action
    {
        ...
        $action = new Action(
            ...
            new ActionTranslation(
                Localisation::mapTranslation('cyvian.actions.labels.duplicate'),
                Localisation::mapTranslation('cyvian.actions.messages.duplicate'),
                Localisation::mapTranslation('cyvian.actions.action_labels.duplicate')
            ),
            $roleIds,
            []
        );
